...
class TestLpAccumulation:
    ...
    def test_continuous_lp_guards_prefill_spike(self):
        ...
        surv_p3 = _drive_lp_cache(3.0, [
            _score({2: 0.9**p, 0: 8 * 0.20**p, 4: 8 * 0.21**p}, 8),
            _score({0: 0.20**p, 4: 0.21**p}, 9),
            _score({0: 0.20**p, 4: 0.21**p}, 10),
        ])
        surv_p1 = _drive_lp_cache(1.0, [
            _score({2: 0.9, 0: 8 * 0.20, 4: 8 * 0.21}, 8),
            _score({0: 0.20, 4: 0.21}, 9),
            _score({0: 0.20, 4: 0.21}, 10),
        ])
